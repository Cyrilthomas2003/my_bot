...
def generate_launch_description():
    ...
    # Define the path to your RViz config file
    rviz_config_file = os.path.join(bringup_dir, 'config', 'my_rv.rviz')
    
    # Define the path to your mapper parameters file
    mapper_params_file = os.path.join(bringup_dir, 'config', 'mapper_params_online_async.yaml')
