...
def generate_launch_description():
    ...
    mode = LaunchConfiguration('mode')  # Add this line to define the mode parameter
    default_params_file = os.path.join(get_package_share_directory("my_bot"), 'config', 'mapper.yaml')
    ...
    declare_mode_argument = DeclareLaunchArgument(
        ...
        description='Mode for slam_toolbox (e.g., mapping or localization)'
    )
    ...
    log_param_change = LogInfo(
        msg=['provided params_file ', params_file, ' does not contain slam_toolbox parameters. Using default: ', default_params_file],
    ...
    start_async_slam_toolbox_node = Node(
        parameters=[
            ...
            {'mode': mode}  # Add the mode parameter here
        ],
    ...
    ld.add_action(declare_mode_argument)  # Add this line to include the mode argument in the launch description
    ld.add_action(log_param_change)
    ld.add_action(start_async_slam_toolbox_node)
    ld.add_action(gazebo_launch)  # Add this line to include the Gazebo launch
    ld.add_action(rviz_launch)    # Add this line to include the RViz launch
